...
Each app has its own `AGENTS.md` with detailed rules:
- `apps/web/AGENTS.md` — Next.js 16, Better Auth, API routes, server/client components.
- `apps/extension/AGENTS.md` — WXT, Manifest V3, content scripts, popup, background service worker.
